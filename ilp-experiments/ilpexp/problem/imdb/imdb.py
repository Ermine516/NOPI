...
class ImdbProblem(Problem):
        ...
        for trial in experiment.trials:
            ...
            for system in experiment.systems:
                ...
                if isinstance(system, Popper):
                    train_settings = self.generate_popper(system,data_path, train_pos, train_neg)
    ...
    def generate_popper(self, system, data_path, pos_examples, neg_examples):
        return PopperTrainSettings(
            ...
            bias_file=curr_dir_relative(f"{system.id}.pl"),
            bk_file=self.bk_file(),
    ...
    def generate_aleph(self, data_path, pos_examples, neg_examples):
        ...
        return aleph.gen_aleph_train_settings(
            ...
            base_aleph_file,
            bk_file,
            ImdbProblem.strip_examples(pos_examples),
            ImdbProblem.strip_examples(neg_examples))
    ...
    def strip_examples(examples):
        for i in range(0,len(examples)):
            examples[i]= examples[i][4:-2]+'.'
        return examples
